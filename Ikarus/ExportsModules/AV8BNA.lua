...
-- V/UHF Radio Panel
	...
	[615] = "%.4f",	--V/UHF RSC Chan/Freq Knob
...
--> McMicha
	...
	if ExportScript.Config.Debug then
	 ...
	 -- string with max 2 charachters
	ExportScript.Tools.SendDataDAC(2010, string.format("%s", lUVHF_Channel))
	 -- string with max 7 charachters
	ExportScript.Tools.SendDataDAC(2011, string.format("%s", lUHF_Freq_Left))
